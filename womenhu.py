...
PUSH_PLUS_TOKEN = '87e7377eb50245d7ab809cb0a2d1f182'

# 多账号配置
# mobile 手机号
# refreshToken 登录后获取的refresh_token
config_list = [
    {"mobile": "16668277742", "refreshToken": "f2bfba3f-b1b6-4166-a60d-d6397442793d"},
    {"mobile": "17638535750", "refreshToken": "4575495b-8e85-4eba-acb5-bd83da44649f"},    
]
################################ 配置区结束 ################################
